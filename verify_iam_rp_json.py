...
'''
def verify_json(iam_role_policy)->bool:
    '''
    ...
    try:
        ...
        for statement in iam_role_policy["PolicyDocument"]["Statement"]: 
            ...
            #if one of the resources is "*" then return False
...
if __name__=="__main__":
    ...
    with open(args["file"],"r") as f:
        iam_rp = json.load(f)
        print(verify_json(iam_rp))
        #print(ver_simple(iam_rp)) #simpler implementation
